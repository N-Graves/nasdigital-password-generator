...
const result = await build({
  ...
  outfile: "dist/password-generator.js",
  bundle: true,
  format: "iife",
  target: "es2020",
  platform: "browser",
...
await build({
  ...
  outfile: "dist/password-generator.css",
  bundle: true,
  minify: false,
  banner: { css: banner },
});

const out = result.metafile.outputs["dist/password-generator.js"];
const css = await readFile(new URL("../dist/password-generator.css", import.meta.url));
...
await writeFile(
  ...
  [
    ...
    "element with a data-pwg attribute.",
    "",
  ].join("\n"),
);
